...
<keywordspec name="RPA.Windows" type="LIBRARY" format="REST" scope="GLOBAL" generated="2025-02-09T15:38:42+00:00" specversion="6" source="./RPA/Windows/__init__.py" lineno="24">
<version/>
...
<kw name="Click" source="./RPA/Windows/keywords/action.py" lineno="30">
...
<returntype name="WindowsElement"/>
...
<kw name="Disable Process Listing" source="./RPA/Windows/keywords/window.py" lineno="411">
<arguments repr="">
</arguments>
...
<kw name="Double Click" source="./RPA/Windows/keywords/action.py" lineno="59">
<arguments repr="locator: WindowsElement | str, wait_time: float | None = None, timeout: float | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Drag And Drop" source="./RPA/Windows/keywords/action.py" lineno="713">
...
<kw name="Enable Process Listing" source="./RPA/Windows/keywords/window.py" lineno="406">
<arguments repr="">
</arguments>
...
<kw name="Get Element" source="./RPA/Windows/keywords/locators.py" lineno="31">
...
<kw name="Get Elements" source="./RPA/Windows/keywords/locators.py" lineno="169">
...
<kw name="Get Text" source="./RPA/Windows/keywords/action.py" lineno="346">
...
<kw name="Get Value" source="./RPA/Windows/keywords/action.py" lineno="379">
<arguments repr="locator: WindowsElement | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Is Selected" source="./RPA/Windows/keywords/action.py" lineno="251">
<arguments repr="locator: WindowsElement | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">
...
<doc>Get the selection state of the element defined by the provided `locator`.
...
.. code-block:: python
    ...
    print(value)</doc>
<shortdoc>Get the selection state of the element defined by the provided `locator`.</shortdoc>
<tags>
<tag>action</tag>
</tags>
</kw>
...
<kw name="Middle Click" source="./RPA/Windows/keywords/action.py" lineno="113">
<arguments repr="locator: WindowsElement | str, wait_time: float | None = None, timeout: float | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Right Click" source="./RPA/Windows/keywords/action.py" lineno="86">
<arguments repr="locator: WindowsElement | str, wait_time: float | None = None, timeout: float | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Screenshot" source="./RPA/Windows/keywords/action.py" lineno="638">
...
<kw name="Select" source="./RPA/Windows/keywords/action.py" lineno="205">
...
<kw name="Send Keys" source="./RPA/Windows/keywords/action.py" lineno="294">
...
<kw name="Set Focus" source="./RPA/Windows/keywords/action.py" lineno="694">
<arguments repr="locator: WindowsElement | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">
...
<kw name="Set Global Timeout" source="./RPA/Windows/keywords/action.py" lineno="672">
...
<returntype name="float" typedoc="float"/>
...
<kw name="Set Mouse Movement" source="./RPA/Windows/keywords/action.py" lineno="777">
...
<kw name="Set Value" source="./RPA/Windows/keywords/action.py" lineno="483">
<arguments repr="locator: WindowsElement | str | None = None, value: str | None = None, append: bool = False, enter: bool = False, newline: bool = False, send_keys_fallback: bool = True, validator: Callable | None = &lt;function set_value_validator at 0x000001CF69122EF0&gt;">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="locator: WindowsElement | str | None = None">
<name>locator</name>
<type name="Union" union="true">
<type name="WindowsElement"/>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="validator: Callable | None = &lt;function set_value_validator at 0x000001CF69122EF0&gt;">
<name>validator</name>
<type name="Union" union="true">
<type name="Callable"/>
<type name="None" typedoc="None"/>
</type>
<default>&lt;function set_value_validator at 0x000001CF69122EF0&gt;</default>
</arg>
</arguments>
<returntype name="WindowsElement"/>
...
<kw name="Set Wait Time" source="./RPA/Windows/keywords/action.py" lineno="612">
